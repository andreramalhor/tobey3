...
class Agendamento extends Component
{
    ...
    // Banco de dados
    public $bd_id;
    public $bd_id_empresa = 1;
    public $bd_start;
    public $bd_end;
    public $bd_duracao;
    public $bd_id_cliente;
    public $bd_id_profexec;
    public $bd_id_servprod;
    public $bd_id_comanda;
    public $bd_valor;
    public $bd_id_criador;
    public $bd_obs;
    public $bd_status;
    public $bd_id_venda_detalhe;
    public $bd_prc_comissao;
    public $bd_vlr_comissao;
    public $bd_grupo;
    ...
    public function criar( $informacoes )
    {
        ...
        // $this->dispatch('adsasdas', ['informacoes' => $informacoes])->to(Agendamento\Criar::class);
        // dd(
        // );
        // $this->bd_id               = null ;
