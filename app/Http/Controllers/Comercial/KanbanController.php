...
class KanbanController extends Controller
{
  ...
  public function kanban_tabelar()
  {
  ...
  public function kanban_mostrar($id)
  {
    $kaban = Kanban::find($id);

    return view('sistema.comercial.crm.mostrar', [
      'kaban' => $kaban,
    ]);
  }

  public function kanban_adicionar()
  {
    return view('sistema.comercial.crm.adicionar');
  }

  public function kanban_gravar(Request $request)
  {
  ...
  public function kanban_editar($id)
  {
    $kaban = Kanban::find($id);
  ...
  public function kanban_excluir(Request $request, $id)
  {
    $kaban = Kanban::find($id);
    ...
    return view('sistema.comercial.crm.index')->with($response);
  }

  public function kanban_atualizar(Request $request, $id)
  {
    $kaban  = Kanban::find($id);
  ...
  // public function kanban_produtos(Request $request, $id)
  // {
  //   $kaban    = Kanban::find($id);
  ...
  public function kanban_produtos_tabelar($id)
  {
    $kaban    = Kanban::
                              // where('tipo', '=', 'Produto')->
                              find($id);

    return view('sistema.comercial.crm.auxiliares.tab_kanban_produtos', [
      'produtos' => $kaban->PZGY650RMFKJ9W7,
    ]);
  }

  public function kanban_servicos_tabelar($id)
  {
    $kaban    = Kanban::
                              // where('tipo', '=', 'Serviço')->
                              find($id);

    return view('sistema.comercial.crm.auxiliares.tab_kanban_servicos', [
      'servicos' => $kaban->LZS394PQT9KN8UZ,
    ]);
  }

  public function kanban_consumos_tabelar($id)
  {
    $kaban    = Kanban::
                              // where('tipo', '=', 'Consumo')->
                              find($id);

    return view('sistema.comercial.crm.auxiliares.tab_kanban_consumos', [
      'consumos' => $kaban->Y6VUVJ8QLZOSW1G,
    ]);
  }

  public function kanban_produtos_incluir(Request $request, $id)
  {
    $kaban    = Kanban::find($id);
  ...
  public function kanban_produtos_adicionar(Request $request, $id)
  {
  ...
  public function kanban_produtos_remover(Request $request, $id)
  {
    $produto = ServicoProduto::withTrashed()->find($request[0]['id_servprod']);
