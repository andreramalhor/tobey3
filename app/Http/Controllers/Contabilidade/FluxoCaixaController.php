...
class FluxoCaixaController extends Controller
{
  ...
  public function fluxo_caixa_tabelar(Request $request)
  {
    $contas = Conta::
  ...
  public function fluxo_caixa_mostrar($id)
  {
  ...
  public function fluxo_caixa_adicionar()
  {
    return view('sistema.atendimentos.pessoas.adicionar');
  }

  public function fluxo_caixa_validar(Request $request, $id)
  {
    $conta = Pessoa::
  ...
  public function fluxo_caixa_gravar(Request $request)
  {
    try
    {
      ...
      if ( !empty( json_decode($request->fluxo_caixa_enderecos) ) )
      {
        foreach ( json_decode($request->fluxo_caixa_enderecos, true) as $atd_address )
        {
      ...
      if ( !empty( json_decode($request->fluxo_caixa_contatos) ) )
      {
        foreach ( json_decode($request->fluxo_caixa_contatos, true) as $atd_contatos )
        {
  ...
  public function fluxo_caixa_avatar(Request $request)
  {
  ...
  public function fluxo_caixa_avatar_remove(Request $request)
  {
  ...
  public function fluxo_caixa_editar($id)
  {
  ...
  public function fluxo_caixa_atualizar(Request $request, $id)
  {
    // return $request->fluxo_caixa_enderecos->toArray();
    $conta     = Pessoa::find($id);
  ...
  public function fluxo_caixa_excluir($id)
  {
    $conta = Pessoa::find($id);
    $conta->delete();
  ...
  public function fluxo_caixa_restaurar($id)
  {
  ...
  public function fluxo_caixa_pesquisar(Request $request)
  {
    if ($request->mode == '=')
    {
      $people = Funcao
  ...
  public function fluxo_caixa_funcoes(Request $request, $id)
  {
    $conta = Pessoa::find($id);
  ...
  public function fluxo_caixa_usuario_verificar($username)
  {
  ...
  // public function fluxo_caixa_permissoes(Request $request, $id)
  // {
  //   $conta    = Pessoa::find($id);
  ...
  // public function fluxo_caixa_usuarios_tabelar($id)
  // {
  //   $conta    = Pessoa::find($id);

  //   return view('sistema.atendimentos.pessoas.auxiliares.tab_fluxo_caixa_usuarios', [
  //     'usuarios' => $conta->pessoa_pessoa,
  //   ]);
  // }

  // public function fluxo_caixa_usuarios_incluir(Request $request, $id)
  // {
  //   $conta    = Pessoa::find($id);
  //   $permissao = Permissao::where('nome', $request[0]['permissao'])->first();
  ...
  // public function fluxo_caixa_usuarios_adicionar(Request $request, $id)
  // {
  //   $conta  = Pessoa::find($id);
  ...
  // public function fluxo_caixa_usuarios_remover(Request $request, $id)
  // {
  //   $conta  = Pessoa::find($id);
  //   $usuario = Pessoa::withTrashed()->find($request[0]['id_pessoa']);
  ...
  public function fluxo_caixa_plucar()
  {
    $contas = Pessoa::
                      orderBy('apelido', 'ASC')->
                      pluck('id', 'apelido');
  ...
  public function fluxo_caixa_procurar($id)
  {
    $contas = Pessoa::
                      find($id);
...
// =======================================================================================================================================================================
  public function fluxo_caixa_equipe_verificar_senha(Request $request, $id)
  {
    $conta = Pessoa::find($id);
  ...
  public function fluxo_caixa_equipe_alterar_senha($id)
  {
...
// ============================================================================================================ contatos
  public function fluxo_caixa_listar_fornecedores()
  {
  ...
  public function fluxo_caixa_sistema(Request $request)
  {
    $parceiros = Pessoa::
  ...
  public function fluxo_caixa_agenda_parceiras(Request $request)
  {
    $parceiros = Pessoa::
                    whereHas('wuclsoqsdppaxmf', function(Builder $query)
                    {
  ...
  public function fluxo_caixa_agenda_ordem()
  {
    $parceiros = Pessoa::
                        whereHas('wuclsoqsdppaxmf', function(Builder $query)
                        {
  ...
  public function fluxo_caixa_agenda_ordem_salvar(Request $request)
  {
  ...
  public function fluxo_caixa_produto_comissao(Request $request)
  {
  ...
  public function fluxo_caixa_vendas($id)
  {
    $vendas = Venda::
                    where('id_cliente', '=', $id)->
  ...
  {
    $clientes = $this->fluxo_caixa_plucar();
