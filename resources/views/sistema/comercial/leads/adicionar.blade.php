...
@include('includes.catch', [ 'codigo_erro' => '5202236a' ] )
};
...
@include('includes.catch', [ 'codigo_erro' => '3222886a' ] )
  }
}
...
@include('includes.catch', [ 'codigo_erro' => '6842342a' ] )
}
...
@include('includes.catch', [ 'codigo_erro' => '5860191a' ] )
  .then()
  {
    $('#foto_enviar').hide();
    $('#foto_cancelar').show();
...
@include('includes.catch', [ 'codigo_erro' => '9295475a' ] )
  .then()
  {
    $('#foto_enviar').show();
    $('#foto_cancelar').hide();
