...
<div class="row">
  <div class="col-12">
    <div class="card">
      ...
      <div
        id='calendar'
        data-carregar="{{ route('atd.Xagendamentos.carregar') }}"
        data-gravar="{{ route('atd.Xagendamentos.gravar') }}"
        data-atualizar="{{ route('atd.Xagendamentos.atualizar', ':id') }}"
        {{--
...
async function retornar_resources()
{
  ...
  return {{ route('atd.agendamentos.parceiros') }}
  salas_parceiras = [];
...
{
  var url = "{{ route('atd.Xagendamentos.criar') }}"
