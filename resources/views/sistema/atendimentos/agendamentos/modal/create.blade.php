...
//     });
//   })
{{-- @include('includes.catch', [ 'codigo_erro' => '9887982a' ] ) --}}
...
@include('includes.catch', [ 'codigo_erro' => '6198075a' ] )
...
@include('includes.catch', [ 'codigo_erro' => '7881224a' ] )
  .then( function()
  {
    setTimeout(function() {
      $('#overlay_create').hide();
...
@include('includes.catch', [ 'codigo_erro' => '6813042a' ] )
  .then( function()
  {
    preencherModal()
  })
...
@include('includes.catch', [ 'codigo_erro' => '6033256a' ] )
  .then(function ()
  {
...
@include('includes.catch', [ 'codigo_erro' => '3483818a' ] )
  .then( function()
  {
...
@include('includes.catch', [ 'codigo_erro' => '7310008a' ] )
  }
  else
