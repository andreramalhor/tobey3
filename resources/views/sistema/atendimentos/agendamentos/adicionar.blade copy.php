...
function validar(item)
{
  ...
  @include('includes.catch', [ 'codigo_erro' => '6239964a' ] )
};
...
function validarISNTA(field)
{
  ...
  if ($('#trocar_foto').is(':checked'))
  {
    ...
    @include('includes.catch', [ 'codigo_erro' => '3582683a' ] )
  }
}
...
@include('includes.catch', [ 'codigo_erro' => '2316467a' ] )
}
...
@include('includes.catch', [ 'codigo_erro' => '1443249a' ] )
  .then()
  {
    $('#foto_enviar').hide();
    $('#foto_cancelar').show();
...
@include('includes.catch', [ 'codigo_erro' => '3438093a' ] )
  .then()
  {
    $('#foto_enviar').show();
    $('#foto_cancelar').hide();
