...
@include('includes.catch', [ 'codigo_erro' => '1829645a' ] )
  .then( function()
  {
    setTimeout(function() {
      $('#overlay_create').hide();
...
function parceiros_carregar()
{
  ...
  axios.get("{{ route('atd.parceiros.plucar') }}")
  .then(function(response)
  {
    // console.log(response.data)
...
@include('includes.catch', [ 'codigo_erro' => '5299265a' ] )
  .then( function()
  {
    setTimeout(function() {
      $('#overlay_create').hide();
...
@include('includes.catch', [ 'codigo_erro' => '8191537a' ] )
  .then( function()
  {
    setTimeout(function() {
      $('#overlay_create').hide();
...
@include('includes.catch', [ 'codigo_erro' => '3723751a' ] )
  .then( function()
  {
    setTimeout(function() {
      $('#overlay_create').hide();
...
//     });
//   })
{{-- @include('includes.catch', [ 'codigo_erro' => '5339131a' ] ) --}}
...
@include('includes.catch', [ 'codigo_erro' => '7417054a' ] )
  ...
  @include('includes.catch', [ 'codigo_erro' => '6280468a' ] )
  .then( function()
  {
    setTimeout(function() {
      $('#overlay_create').hide();
...
@include('includes.catch', [ 'codigo_erro' => '4904309a' ] )
  .then(function ()
  {
...
@include('includes.catch', [ 'codigo_erro' => '4356212a' ] )
  .then( function()
  {
...
@include('includes.catch', [ 'codigo_erro' => '2281702a' ] )
  }
  else
