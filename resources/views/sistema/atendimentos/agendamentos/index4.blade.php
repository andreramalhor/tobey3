...
document.addEventListener('DOMContentLoaded', function() {
  ...
  @include('includes.catch', [ 'codigo_erro' => '1524912a' ] )
    },
    // resources: function(fetchInfo, successCallback, failureCallback)
    // {
    //   retornar_resources(function(resources)
    //   {
    //     successCallback(resources);
    //   })
    // },
    // resources: retornar_resources(),
    // resources: 
    // [
...
//   sendEvent(route, Event)
// });
// let betterDeveloper('zerinho')
// url  = "{{ route('atd.pessoas.sistema') }}";
// const retornar_resources = fetch(url);
...
//     //   console.log(value)
//     //   console.log('----------')
//     //   salas_parceiras.push({ 'id': value.id, 'title': value.apelido })
//     // })
//     // console.log('============================================================')
//     // console.log(salas_parceiras)
//     // console.log('============================================================')
//   })
{{-- @include('includes.catch', [ 'codigo_erro' => '5569888a' ] ) --}}
      // .them( function (data)
      // {
    //   console.log(data)
    //   salas_parceiras.push({id: '11', title: '11 Juci' })
    //   salas_parceiras.push({id: '22', title: '22 Luan' })
    //   salas_parceiras.push({id: '33', title: '33 Mari' })
    //   salas_parceiras.push({id: '44', title: '44 Kami' })
    //   salas_parceiras.push({id: '55', title: '55 Eman' })
    //   salas_parceiras.push({id: '66', title: '66 Eulê' })
    //   salas_parceiras.push({id: '77', title: '77 Leil' })
    //   salas_parceiras.push({id: '88', title: '88 Rita' })
    //   salas_parceiras.push({id: '99', title: '99 Suel' })
    //   salas_parceiras.push({id: '36', title: '36 andr' })
...
async function retornar_resources()
{
  ...
  // const usersalas = await fetch("{{ route('atd.pessoas.sistema') }}")
  // .then( (resp) => resp.json())
  // .then( function (data)
  // {
  //   collect(data).each((value, key) =>
...
//     console.log(result)
//   })
{{-- @include('includes.catch', [ 'codigo_erro' => '2896934a' ] ) --}}
...
//   })
{{-- @include('includes.catch', [ 'codigo_erro' => '1168998a' ] ) --}}
...
//     // })
//   // })
//   {{-- @include('includes.catch', [ 'codigo_erro' => '1885727a' ] ) --}}
//   // .then( function ()
//   // {
//     // console.log(salas_parceiras);
//     return salas_parceiras;
...
@include('includes.catch', [ 'codigo_erro' => '7946829a' ] )
}
...
@include('includes.catch', [ 'codigo_erro' => '2468740a' ] )
  .then( function()
  {
...
@include('includes.catch', [ 'codigo_erro' => '4717107a' ] )
  .then( function()
  {
    $('#modal-geral-1').modal('show')
  })
