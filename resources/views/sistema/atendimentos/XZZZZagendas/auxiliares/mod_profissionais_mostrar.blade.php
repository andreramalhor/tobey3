...
@include('includes.catch', [ 'codigo_erro' => '6913191a' ] )
  .then()
  {
    setTimeout(() => 
    {
...
@include('includes.catch', [ 'codigo_erro' => '6946921a' ] )
  .then(function()
  {
...
@include('includes.catch', [ 'codigo_erro' => '7852939a' ] )
    .then(function ()
    {
      $('#modal-geral-1').modal('hide')
  ...
  @include('includes.catch', [ 'codigo_erro' => '8408638a' ] )
      .then(function ()
      {
        $('#modal-geral-1').modal('hide')
