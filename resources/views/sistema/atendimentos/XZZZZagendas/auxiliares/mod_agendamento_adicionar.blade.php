...
@include('includes.catch', [ 'codigo_erro' => '6141614a' ] )
  .then( function()
  {
    setTimeout(function() {
      $('#overlay_create').hide();
...
function parceiros_carregar()
{
  ...
  axios.get("{{ route('atd.parceiros.plucarr') }}")
  .then(function(response)
  {
    // console.log(response.data)
...
@include('includes.catch', [ 'codigo_erro' => '8002093a' ] )
  .then( function()
  {
    setTimeout(function() {
      $('#overlay_create').hide();
...
@include('includes.catch', [ 'codigo_erro' => '1118615a' ] )
  .then( function()
  {
    setTimeout(function() {
      $('#overlay_create').hide();
...
@include('includes.catch', [ 'codigo_erro' => '9172797a' ] )
  .then( function()
  {
    setTimeout(function() {
      $('#overlay_create').hide();
...
//     });
//   })
{{-- @include('includes.catch', [ 'codigo_erro' => '9333876a' ] ) --}}
...
@include('includes.catch', [ 'codigo_erro' => '1693610a' ] )
...
@include('includes.catch', [ 'codigo_erro' => '3619258a' ] )
  .then( function()
  {
    setTimeout(function() {
      $('#overlay_create').hide();
...
@include('includes.catch', [ 'codigo_erro' => '9374178a' ] )
  .then(function ()
  {
...
@include('includes.catch', [ 'codigo_erro' => '4135022a' ] )
  .then( function()
  {
...
@include('includes.catch', [ 'codigo_erro' => '3108033a' ] )
  }
  else
