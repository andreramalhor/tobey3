...
<!-- 
            ...
            <p class="text-muted">Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua butcher retro keffiyeh dreamcather synth. Cosby sweater eu banh mi, qui irure terr.</p>
            <br>
...
<script type="text/javascript">
  ...
  @include('includes.catch', [ 'codigo_erro' => '2303219a' ] )
      .then(function ()
      {
...
@include('includes.catch', [ 'codigo_erro' => '7126923a' ] )
        .then(function ()
        {
          $('#modal-geral-1').modal('hide')
...
@include('includes.catch', [ 'codigo_erro' => '4058595a' ] )
    .then(function ()
    {
      setTimeout(function() {
        agendamentos_recarregar()
...
@include('includes.catch', [ 'codigo_erro' => '3799639a' ] )
  .then()
  {
    setTimeout(() => 
    {
...
@include('includes.catch', [ 'codigo_erro' => '2285365a' ] )
  .then(function()
  {
    $('#modal-geral-1').modal('hide')
    agendamentos_recarregar()
