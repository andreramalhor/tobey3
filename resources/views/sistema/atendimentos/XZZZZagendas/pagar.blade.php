...
@include('includes.catch', [ 'codigo_erro' => '8143259a' ] )
  .then( function()
  {
...
function ajustar_valor(e)
{
  ...
  {
    $("#valor").attr({"readonly": false}).val(accounting.formatMoney( pdv_comanda_totais.vlr_restante , '')).focus()
...
@include('includes.catch', [ 'codigo_erro' => '6719529a' ] )
}
