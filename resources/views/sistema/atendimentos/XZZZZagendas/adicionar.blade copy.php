...
@include('includes.catch', [ 'codigo_erro' => '8128611a' ] )
};
...
@include('includes.catch', [ 'codigo_erro' => '5170815a' ] )
  }
}
...
@include('includes.catch', [ 'codigo_erro' => '2029609a' ] )
}
...
@include('includes.catch', [ 'codigo_erro' => '3829499a' ] )
  .then()
  {
    $('#foto_enviar').hide();
    $('#foto_cancelar').show();
...
@include('includes.catch', [ 'codigo_erro' => '3543843a' ] )
  .then()
  {
    $('#foto_enviar').show();
    $('#foto_cancelar').hide();
