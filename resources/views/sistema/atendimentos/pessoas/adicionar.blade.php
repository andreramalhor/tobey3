...
function validar(item)
{
  ...
  @include('includes.catch', [ 'codigo_erro' => '5733885a' ] )
};
...
function validarISNTA(field)
{
  ...
  if ($('#trocar_foto').is(':checked'))
  {
    ...
    @include('includes.catch', [ 'codigo_erro' => '9101726a' ] )
  }
}
...
function pessoa_gravar()
{
  ...
  @include('includes.catch', [ 'codigo_erro' => '9333021a' ] )
}
...
function pessoa_avatar_gravar()
{
  ...
  @include('includes.catch', [ 'codigo_erro' => '3791966a' ] )
  .then()
  {
    $('#foto_enviar').hide();
    $('#foto_cancelar').show();
...
function pessoas_avatar_remove()
{
  ...
  @include('includes.catch', [ 'codigo_erro' => '5249075a' ] )
  .then()
  {
    $('#foto_enviar').show();
    $('#foto_cancelar').hide();
