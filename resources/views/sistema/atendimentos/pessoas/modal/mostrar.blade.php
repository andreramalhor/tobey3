<div class="modal-dialog modal-xl" style="width: 95% !important; max-width: 95% !important;">
  <div class="modal-content">
    <!-- <div class="overlay-modal-usuario-incluir"> -->
      <!-- <i class="fas fa-2x fa-sync fa-spin"></i> -->
      <!-- </div> -->
      <div class="modal-header bg-primary" style="padding: 8px 16px">
        <h5 class="modal-title">Detalhes da Pessoa: {{ $pessoa->id }}</h5>
              ...
              <div class="card">
                <div class="card-body box-profile">
                  <div class="text-center">
                    <img class="profile-user-img img-fluid img-circle" src="{{ $pessoa->foto_perfil }}" alt="User profile picture"  data-bs-tooltip="tooltip" data-bs-title="{{ $pessoa->apelido }}">
                  </div>
                ...
                <div class="card-body">
                  <div class="tab-content">
                    <div class=" tab-pane active" id="painel">
                      @include('sistema.atendimentos.pessoas.auxiliares.01_inc_mostrar_painel')
                    </div>
                    <div class="tab-pane" id="sobre">
                      @include('sistema.atendimentos.pessoas.auxiliares.02_inc_mostrar_sobre')
                    </div>
                    <div class="tab-pane" id="agendamentos">
                      @include('sistema.atendimentos.pessoas.auxiliares.inc_mostrar_agendamentos')
                    </div>
