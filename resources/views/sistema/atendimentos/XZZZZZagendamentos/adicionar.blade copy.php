                ...
                <div class="col-12">
                  <div class="widget-user-header">
                    <div class="widget-user-image text-center">
                      @php $url = asset('img/atendimentos/pessoas/perfil/0.png') @endphp
                      <input type="hidden" name="foto_padrao" id="foto_padrao" value="{{ $url }}">
                      <img class="img-circle elevation-1" src="{{ asset('img/atendimentos/pessoas/perfil/0.png') }}" alt="User Avatar" height="155px" id="profile_picture">
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="input-group">
                    ...
                    {{-- <div class="input-group-append"> --}}
                      {{-- <div class="input-group-text"> --}}
                        {{-- <input type="checkbox" id="trocar_foto" data-bs-tooltip="tooltip" title="Substituir Foto" checked onchange="validar(this)"> --}}
                      {{-- </div> --}}
                    {{-- </div> --}}
                  </div>
                </div>
...
@include('includes.catch', [ 'codigo_erro' => '5637464a' ] )
};
...
@include('includes.catch', [ 'codigo_erro' => '3591468a' ] )
  }
}
...
@include('includes.catch', [ 'codigo_erro' => '7484829a' ] )
}
...
@include('includes.catch', [ 'codigo_erro' => '3337987a' ] )
  .then()
  {
    $('#foto_enviar').hide();
    $('#foto_cancelar').show();
...
@include('includes.catch', [ 'codigo_erro' => '2457232a' ] )
  .then()
  {
    $('#foto_enviar').show();
    $('#foto_cancelar').hide();
