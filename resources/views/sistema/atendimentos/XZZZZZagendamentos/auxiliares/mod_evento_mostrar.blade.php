  ...
  <div class="modal-dialog mw-100 mh-100" style="width: 95%; height: 95%;">
    <div class="modal-content" style="height: 95%;">
      ...
      <div class="modal-header" style="padding: 8px 16px; background-color: {{ $agendamento->color }}">
        <h4 class="modal-title">{{ $agendamento->xhooqvzhbgojbtg->apelido ?? 'Cliente'}}</span></h4>
          ...
          <div class="col-12 col-md-12 col-lg-4 order-1">
            <div class="post">
              <div class="user-block pb-2">
                ...
                <span class="username">
                  <a href="#">{{ $agendamento->xhooqvzhbgojbtg->apelido ?? 'Cliente'}}</a>
                </span>
...
<!-- 
            ...
            <p class="text-muted">Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua butcher retro keffiyeh dreamcacher synth. Cosby sweater eu banh mi, qui irure terr.</p>
            <br>
...
@include('includes.catch', [ 'codigo_erro' => '2362206a' ] )
    .then(function ()
    {
  ...
  @include('includes.catch', [ 'codigo_erro' => '7664111a' ] )
      .then(function ()
      {
        $('#modal-geral-1').modal('hide')
...
@include('includes.catch', [ 'codigo_erro' => '3191570a' ] )
  .then()
  {
    setTimeout(() => 
    {
...
@include('includes.catch', [ 'codigo_erro' => '4014111a' ] )
  .then(function()
  {
    $('#modal-geral-1').modal('hide')
    agendamentos_recarregar()
