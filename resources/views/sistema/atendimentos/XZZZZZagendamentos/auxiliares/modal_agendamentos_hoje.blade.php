          ...
          <div class="col-12 table-responsive pl-0">
              <table class="table table-hover table-condensed table-sm table-striped no-padding table-valign-middle">
                ...
                <tbody>
                  ...
                  <tr style="background-color: {{ $agendamento->color }}">
                    ...
                    <td class="text-center">
                      <a style="cursor:pointer;" onclick="agendamento_adicionar(
...
@include('includes.catch', [ 'codigo_erro' => '4259209a' ] )
}
...
@include('includes.catch', [ 'codigo_erro' => '8178649a' ] )
}  
...
async function agendamento_adicionar( id_servprod, vlr_servprod, id_profexec, apelido_profissional )
{
