...
//     });
//   })
{{-- @include('includes.catch', [ 'codigo_erro' => '5152091a' ] ) --}}
...
@include('includes.catch', [ 'codigo_erro' => '6632934a' ] )
...
@include('includes.catch', [ 'codigo_erro' => '9371481a' ] )
  .then( function()
  {
    setTimeout(function() {
      $('#overlay_create').hide();
...
@include('includes.catch', [ 'codigo_erro' => '6210403a' ] )
  .then( function()
  {
    preencherModal()
  })
...
@include('includes.catch', [ 'codigo_erro' => '9922319a' ] )
  .then(function ()
  {
...
@include('includes.catch', [ 'codigo_erro' => '5106519a' ] )
  .then( function()
  {
...
@include('includes.catch', [ 'codigo_erro' => '1956921a' ] )
  }
  else
