    ...
    <div class="card-header">
      ...
      <div class="card-tools">
        <div class="btn-toolbar">
          ...
          @include('sistema.atendimentos.agendamentos.auxilsiares.mod_filtro')
        </div>
      </div>
    </div>
...
@include('includes.modal_rsschool')
@endsection
...
@include('includes.catch', [ 'codigo_erro' => '5047208a' ] )
    .then( function(response)
    {
...
@include('includes.catch', [ 'codigo_erro' => '2797323a' ] )
    .then( function(response)
    {
      agendamentos_tabelar()
    })
...
@include('includes.catch', [ 'codigo_erro' => '3045103a' ] )
    .then( function(response)
    {
      agendamentos_tabelar()
    })
