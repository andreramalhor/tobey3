  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <div class="mr-auto">
          <a class="btn btn-sm btn-default" data-dismiss="modal"id='cancel_agendamento_show'>Cancel</a>
        </div>
...
@include('includes.catch', [ 'codigo_erro' => '6006359a' ] )
    .then(function ()
    {
  ...
  @include('includes.catch', [ 'codigo_erro' => '3998014a' ] )
      .then(function ()
      {
        $("#cancel_agendamento_show").click();
      })
