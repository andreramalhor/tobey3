...
//     });
//   })
{{-- @include('includes.catch', [ 'codigo_erro' => '2377733a' ] ) --}}
...
@include('includes.catch', [ 'codigo_erro' => '9789762a' ] )
...
@include('includes.catch', [ 'codigo_erro' => '1947290a' ] )
  .then( function()
  {
    setTimeout(function() {
      $('#overlay_create').hide();
...
@include('includes.catch', [ 'codigo_erro' => '4047395a' ] )
  .then( function()
  {
    preencherModal()
  })
...
@include('includes.catch', [ 'codigo_erro' => '8236545a' ] )
  .then(function ()
  {
...
@include('includes.catch', [ 'codigo_erro' => '7174831a' ] )
  .then( function()
  {
...
function preencher_modal_Cliente()
{
  ...
  if (dados_do_cliente.instagram != null)
  {
    ...
    @include('includes.catch', [ 'codigo_erro' => '4481577a' ] )
  }
  else
