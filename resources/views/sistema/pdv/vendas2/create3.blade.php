...
function validar(field)
{
  ...
  @include('includes.catch', [ 'codigo_erro' => '4110237a' ] )
...
@include('includes.catch', [ 'codigo_erro' => '4957999a' ] )
});
</script>
@endsection --}}
...
<script>
  ...
  @include('includes.catch', [ 'codigo_erro' => '9445938a' ] )
      .then( function() {
        setTimeout(function() {
          $('#overlay_cliente').hide();
        }, 500);
...
@include('includes.catch', [ 'codigo_erro' => '3930776a' ] )
  }
...
@include('includes.catch', [ 'codigo_erro' => '6019963a' ] )
    .then( function() {
      setTimeout(function() {
