...
@include('includes.catch', [ 'codigo_erro' => '3334310a' ] )
};
...
@include('includes.catch', [ 'codigo_erro' => '3986491a' ] )
});
...
@include('includes.catch', [ 'codigo_erro' => '6885942a' ] )
  .then()
  {
    $('#imagem_enviar').hide();
...
@include('includes.catch', [ 'codigo_erro' => '7748126a' ] )
  .then()
  {
    $('#imagem_enviar').show();
