...
<div class="row">
  ...
  <div class="row">
    <div class="col-12">
      ...
      <a class="btn btn-success float-right" style="color:white" id="btn_produto_editar">Editar</a>
    </div>
  </div>
</form>
<br>
...
@include('includes.catch', [ 'codigo_erro' => '2181342a' ] )
};

$("#btn_produto_editar").click(function(event)
{
...
@include('includes.catch', [ 'codigo_erro' => '4642634a' ] )
});
...
@include('includes.catch', [ 'codigo_erro' => '7019615a' ] )
  .then()
  {
    $('#imagem_enviar').hide();
...
@include('includes.catch', [ 'codigo_erro' => '8645574a' ] )
  .then()
  {
    $('#imagem_enviar').show();
