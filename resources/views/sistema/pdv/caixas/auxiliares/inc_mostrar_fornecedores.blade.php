...
<div class="row">
	<div class="col-12">
		<div class="card">
			<div class="card-body table-responsive p-0">
  			<table class="table table-sm table-striped no-padding table-valign-middle projects">
    			<thead class="table-dark">				
					...
					<tbody>
						{{--
							@forelse( $caixa->xcuwqubcfetnftm as $fornecedor )
							<tr>
            ...
            @empty
						<tr>
							<td class="text-center" colspan="5">Não há fornecedores cadastrado para esse caixa</td>
						</tr>
            @endforelse
						--}}
					</tbody>
...
@include('sistema.pdv.caixas.auxiliares.mod_fornecedor_adicionar')
