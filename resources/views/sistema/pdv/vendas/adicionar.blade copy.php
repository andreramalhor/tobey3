                  ...
                  <div class="input-group">
                    ...
                    {{-- <div class="input-group-append"> --}}
                      {{-- <div class="input-group-text"> --}}
                        {{-- <input type="checkbox" id="trocar_foto" data-tt="tooltip" title="Substituir Foto" checked onchange="validar(this)"> --}}
                      {{-- </div> --}}
                    {{-- </div> --}}
                  </div>
                </div>
...
function validar(item)
{
  ...
  @include('includes.catch', [ 'codigo_erro' => '1320971a' ] )
};
...
function validarISNTA(field)
{
  ...
  if ($('#trocar_foto').is(':checked'))
  {
    ...
    @include('includes.catch', [ 'codigo_erro' => '6566178a' ] )
  }
}
...
function pessoa_gravar()
{
  ...
  @include('includes.catch', [ 'codigo_erro' => '7534965a' ] )
}
...
function pessoa_avatar_gravar()
{
  ...
  @include('includes.catch', [ 'codigo_erro' => '7047351a' ] )
  .then()
  {
    $('#foto_enviar').hide();
    $('#foto_cancelar').show();
...
function pessoas_avatar_remove()
{
  ...
  @include('includes.catch', [ 'codigo_erro' => '9671747a' ] )
  .then()
  {
    $('#foto_enviar').show();
    $('#foto_cancelar').hide();
