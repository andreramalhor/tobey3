    ...
    <div class="modal-body">
      <div class="row">
        <div class="col-12 form-group">
          ...
          <table width="100%">
            <tr>
              <td style="width:1%; white-space:nowrap;"><strong>ID Cliente: </strong><a target="_blank" class="badge bg-pink"><span onclick="pessoas_mostrar_modal({{ $venda->id_cliente }})" style="cursor: pointer;">{{ $venda->id_cliente }}</span></a>&emsp;&nbsp;&emsp;</td>
