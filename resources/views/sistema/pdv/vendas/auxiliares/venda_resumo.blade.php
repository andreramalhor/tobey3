    ...
    <div class="card">
      ...
      <div class="card-body p-2">
        <div class="row invoice-info">
          ...
          <div class="col-12 col-sm-12 col-md-2 col-lg-2 col-xl-2 invoice-col">
            <strong>#ID</strong><br>
            <p class="text-muted mb-1">{{ isset($venda->cliente) ? $venda->cliente->id : '0' }}</p>
          </div>
          
          <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 invoice-col">
        ...
        <div class="row">
          <div class="col-12 col-sm-12 col-md-7 col-lg-7 col-xl-7">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 table-responsive pl-0">
                  ...
                  @if(isset($venda->pdv_vendas_detalhes) && count($venda->pdv_vendas_detalhes) > 0 )
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <a onclick="pdv_vendas_detalhes_excluir({{ $produto["identificador"] }})" class="text-muted text-red" data-tt="tooltip" title="Excluir" data-original-title="Excluir"><i class="fa-solid fa-times"></i></a>
                      </td>
                    </tr>
                    @endforeach
                  @else
                ...
                <tbody>
                  @if(isset($venda->pdv_vendas_pagamentos) && count($venda->pdv_vendas_pagamentos) > 0 )
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <a onclick="pdv_vendas_pagamentos_excluir({{ $pagamento["identificador"] }})" class="text-muted text-red" data-tt="tooltip" title="Excluir" data-original-title="Excluir"><i class="fa-solid fa-times"></i></a>
                      </td>
                    </tr>
                    @endforeach
                  @else
