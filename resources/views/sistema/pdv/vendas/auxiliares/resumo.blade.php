      ...
      <div class="modal-header with-border">
        <div class="col-12">
          <div class="row">
            <table width="100%">
              <tr>
                <td rowspan="4" class="text-center" id="col_logo" width="75"><img src="{{ asset('img/atendimentos/pessoas/0.png') }}" alt="Nome da empresa" width="75" style="margin-right: 50px;"></td>
...
@include('includes.catch', [ 'codigo_erro' => '2907333a' ] )
  .then( function()
  {
