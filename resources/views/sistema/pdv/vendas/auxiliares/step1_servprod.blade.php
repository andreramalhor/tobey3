...
<script>
  ...
  function servprod_executor_selecionado( id )
  {
    ...
    @include('includes.catch', [ 'codigo_erro' => '2629806a' ] )
    .then(function()
    {
  ...
  function atualizar_cmp_vendas()
  {
    ...
    switch (temp.pdv_vendas_detalhes.tipo)
    {
      case 'Produto':
        ...
        if(temp.pdv_vendas_detalhes.estoque_atual < 1 || 1 == 2)   //coloquei 1 == 2 para passar em todos os casos. NAO CONFERIR ESTOQUE
        {
