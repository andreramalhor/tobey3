<div class="row">
  <div class="row invoice-info">
    ...
    <div class="col-sm-10 invoice-col pb-3">
    	<a class="" href="https://www.instagram.com/{{ $pessoa->instagram }}" target="_black" data-tt="tooltip" title="Instagram"><i class="fa-brands fa-instagram"></i></a> {{ $pessoa->instagram ?? ' - ' }}<br>
      <a class="" href="https://www.facebook.com/{{ $pessoa->facebook }}" target="_black" data-tt="tooltip" title="Facebook"><i class="fa-brands fa-facebook"></i></a> {{ $pessoa->facebook ?? ' - ' }}
    </div>
    ...
    <div class="col-sm-10 invoice-col pb-3">
      @forelse($pessoa->uqbchiwyagnnkip as $endereco)
	     <a class="" href="https://www.google.com.br/maps/search/{{ $endereco->tipo_endereco }} {{ $endereco->logradouro }} {{ $endereco->numero }} {{ $endereco->bairro }} {{ $endereco->cidade }} {{ $endereco->uf }} {{ $endereco->cep }}" target="_black" data-tt="tooltip" title="Endereço"><i class="fa-solid fa-map-location"></i></a>
    ...
    <div class="col-sm-10 invoice-col pb-3">
      @forelse($pessoa->ginthgfwxbdhwtu->sortbyDesc('whatsapp') as $contato)
          @if($contato->whatsapp)
	          <a class="" href="https://api.whatsapp.com/send?phone=55{{ $contato->tellink }}" target="_black" data-tt="tooltip" title="WhatsaApp"><i class="fa-brands fa-whatsapp"></i></a>
          @else
	          <a class="" href="tel:+55{{ $contato->tellink }}" target="_black" data-tt="tooltip" title="Telefone"><i class="fa-solid fa-phone"></i></a>
          @endif
