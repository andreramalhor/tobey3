<div class="modal fade" id="modal_pessoas_filtrar" aria-hidden="true" style="display: none; color: black;">
    ...
    <form autocomplete="off" id="form-filtro">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-between" style="padding: 6px 12px">
          <a class="btn btn-default" style="color:black" data-dismiss="modal" id='cancel_modal_funcoes_usuarios_incluir'>Cancel</a>

          {{-- <button type="button" class="btn btn-default btn-sm" id="btn_clean" onclick="cleanFilter()" data-dismiss="modal">Limpar</button> --}}

          <button type="button" class="btn btn-primary btn-sm" onclick="pessoas_tabelar()" data-dismiss="modal">Filtrar</button>
        </div>
      </div>
    </div>
  </form>
