    ...
    @if (isset($pessoa))
      ...
      var endereco = {
        ...
        'acoes'           : '<div class="btn-group">'+
          '<a onclick="endereco_excluir('+({{ $loop->index + 1  }})+');" class="btn btn-default btn-xs" data-tt="tooltip" title="Remover"><i class="fas fa-trash-alt"></i></a>'+
        '</div>',
      };
...
$("#submit_pessoas_endereco").on('click', function (e)
{
  ...
  var endereco = {
    ...
    'acoes'           : '<div class="btn-group">'+
                          '<a onclick="endereco_excluir('+(endereco_indice() + 1)+');" class="btn btn-default btn-xs" data-tt="tooltip" title="Remover"><i class="fas fa-trash-alt"></i></a>'+
                        '</div>',
  };
