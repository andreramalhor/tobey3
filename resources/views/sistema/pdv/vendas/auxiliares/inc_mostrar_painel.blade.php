		...
		<div class="card">
			...
			<div class="card-body p-0">
				<table class="table table-sm">
					...
					<tbody>
						@forelse($pessoa->eidwuedesduz-sdc('id')->take(5) as $vendas_detalhes)
						<tr>
							<td class="text-nowrap text-left"><a href="" data-bs-toggle="modal" onclick="showVenda({{ $vendas_detalhes->sbbgaqleesuzlus->id ?? $vendas_detalhes->id_venda ?? 'Erro SHOW.PESSOA 1' }})"><span class="badge bg-pink">{{ $vendas_detalhes->sbbgaqleesuzlus->id ?? $vendas_detalhes->id_venda ?? 'Erro SHOW.PESSOA 1' }}</span></a></td>                          
