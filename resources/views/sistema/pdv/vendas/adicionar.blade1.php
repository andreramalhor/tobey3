...
@include('includes.catch', [ 'codigo_erro' => '6196161a' ] )
};
...
@include('includes.catch', [ 'codigo_erro' => '5354952a' ] )
  }
}
...
@include('includes.catch', [ 'codigo_erro' => '4170631a' ] )
}
...
@include('includes.catch', [ 'codigo_erro' => '8769288a' ] )
  .then()
  {
    $('#foto_enviar').hide();
    $('#foto_cancelar').show();
...
@include('includes.catch', [ 'codigo_erro' => '5367504a' ] )
  .then()
  {
    $('#foto_enviar').show();
    $('#foto_cancelar').hide();
