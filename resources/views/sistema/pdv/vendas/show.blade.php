        ...
        <div class="card-header with-border">
          <div class="row">
            <div class="col-12">
              <table width="100%">
                <tr>
                  <td rowspan="4" class="text-center" id="col_logo" width="75"><img src="{{ asset('img/Atendimentos/Pessoas/Perfil/0.png') }}" alt="Espaço Milady" width="75" style="margin-right: 50px;"></td>
                ...
                <tr>
                  ...
                  <td><strong>ID Caixa: &nbsp;</strong><a href="{{ route('caixa.show', $venda->id_caixa) }}" class="badge bg-pink">{{ $venda->id_caixa }}</a></td>
                </tr>
                <tr>
        ...
        <div class="card-body">
            ...
            <div class="col-12 form-group ">
              ...
              <table width="100%">
                <tr>
                  ...
                  @endif
                  <td><strong>Nome: </strong>{{ $venda->AtdPessoasClientesVendas->nome ?? 'Cliente não cadastrado' }}</td>
                  @if (isset($venda->AtdPessoasClientesVendas->cpf_cnpj))
                    <td class="text-right"><strong>CPF: </strong>{{ $venda->AtdPessoasClientesVendas->cpf_cnpj }}</td>
                  @endif
                </tr>
              </table>
          ...
          <div class="row">
            <div class="col-12 form-group ">
              ...
              <table class="table-striped" width="100%">
                ...
                @forelse($venda->PDVVendasDetalhesProdutos as $produto)
                  <tr>
                    <td class="text-left">{{ $produto->id_prod_serv }}</td>
                    <td class="text-left">{{ $produto->PDVServicoProdutosVendasDetalhes->nome ?? 'ERROOOOIU' }}</td>
                    <td class="text-left">{{ $produto->hgihnjekboyabez->DetalhesDoProfissionalQueFezEssaVenda->apelido ?? $produto->hgihnjekboyabez->id_pessoa ?? $produto->id }}</td>
                ...
                @endforelse
                @if (count($venda->PDVVendasDetalhesProdutos))
                  <tr>
                    <td class="text-left"><strong>Itens: {{ $venda->PDVVendasDetalhesProdutos->count() }}</strong></td>
                    <td class="text-left"></td>
                    <td class="text-left"></td>
                    <td class="text-right"><strong>{{ number_format($venda->PDVVendasDetalhesProdutos->sum('vlr_final'), 2, ',', '.') }}</td></strong>
                  </tr>
                @endif
              </table>
            </div>
          ...
          <div class="row">
            <div class="col-12 form-group ">
              ...
              <table class="table-striped" width="100%">
                @forelse($venda->PDVVendasPagamentosVendas as $pagamento)
                  <tr>
                    <td class="text-left"><strong>Forma: </strong>{{ $pagamento->PDVFormasPagamentosVendasPagamentos->forma }} {{ $pagamento->PDVFormasPagamentosVendasPagamentos->bandeira == $pagamento->PDVFormasPagamentosVendasPagamentos->forma ? '' : ' - '.$pagamento->PDVFormasPagamentosVendasPagamentos->bandeira }} {{ $pagamento->PDVFormasPagamentosVendasPagamentos->parcela > 1 ? '('.$pagamento->PDVFormasPagamentosVendasPagamentos->parcela.'x)' : '' }}</td>
                ...
                @if (count($venda->PDVVendasDetalhesProdutos))
                  <tr>
                    ...
                    <td></td>
                    <td></td>
                    <td class="text-right"><strong>Total: {{ number_format($venda->PDVVendasPagamentosVendas->sum('valor'), 2, ',', '.') }}</td></strong>
                  </tr>
                @endif
              </table>
