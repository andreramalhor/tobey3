...
@include('includes.catch', [ 'codigo_erro' => '7177973a' ] )
};
...
@include('includes.catch', [ 'codigo_erro' => '2629961a' ] )
  }
}
...
@include('includes.catch', [ 'codigo_erro' => '7988310a' ] )
}
...
@include('includes.catch', [ 'codigo_erro' => '2190145a' ] )
  .then()
  {
    $('#foto_enviar').hide();
    $('#foto_cancelar').show();
...
@include('includes.catch', [ 'codigo_erro' => '1913068a' ] )
  .then()
  {
    $('#foto_enviar').show();
    $('#foto_cancelar').hide();
