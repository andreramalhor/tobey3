      ...
      <div class="card-body p-2">
        <div class="row invoice-info">
          ...
          <div class="col-sm-4 invoice-col">
            ...
            <p class="text-muted mb-1">{{ isset($venda->cliente) ? $venda->cliente->nome : '(Cliente sem cadastro)' }}{{ isset($venda->cliente) ? ' - ('.$venda->cliente->apelido.')' : '' }}</p>
          </div>
                ...
                <tbody>
                  @if(isset($venda->pdv_vendas_detalhes) && count($venda->pdv_vendas_detalhes) > 0 )
                    ...
                    <tr>
                      ...
                      <td class="text-right">
                        <a onclick="pdv_vendas_detalhes_excluir({{ $produto['identificador'] }})" class="text-muted" data-bs-tooltip="tooltip" data-bs-title="Excluir" data-original-title="Excluir"><i class="fa-solid fa-times"></i></a>
                      </td>
                    </tr>
                    @endforeach
                  @else
                  <tr>
                    <td colspan="6" class="text-center">Ainda não foi lançado nenhum produto / serviço.</td>
                  </tr>
                  @endif
                </tbody>
                @if(isset($venda->pdv_vendas_detalhes) && count($venda->pdv_vendas_detalhes) > 0 )
            ...
            <div class="col-12 table-responsive pl-0">
              <table class="table table-hover table-condensed table-sm table-striped no-padding table-valign-middle">
                ...
                <tbody>
                  ...
                  @else
                  <tr>
                    <td colspan="5" class="text-center">Ainda não há registros de pagamentos.</td>
                  </tr>
                  @endif
                </tbody>
                @if(isset($venda->pdv_vendas_pagamentos) && count($venda->pdv_vendas_pagamentos) > 0 )
