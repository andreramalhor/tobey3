...
@include('includes.catch', [ 'codigo_erro' => '3841108a' ] )
};
...
@include('includes.catch', [ 'codigo_erro' => '6148080a' ] )
  }
}
...
@include('includes.catch', [ 'codigo_erro' => '9160814a' ] )
}
...
@include('includes.catch', [ 'codigo_erro' => '2464296a' ] )
  .then()
  {
    $('#foto_enviar').hide();
    $('#foto_cancelar').show();
...
@include('includes.catch', [ 'codigo_erro' => '3734357a' ] )
  .then()
  {
    $('#foto_enviar').show();
    $('#foto_cancelar').hide();
