...
@include('includes.catch', [ 'codigo_erro' => '4204393a' ] )
};
...
@include('includes.catch', [ 'codigo_erro' => '4590574a' ] )
});
...
@include('includes.catch', [ 'codigo_erro' => '2407385a' ] )
  .then()
  {
    $('#imagem_enviar').hide();
...
@include('includes.catch', [ 'codigo_erro' => '2607675a' ] )
  .then()
  {
    $('#imagem_enviar').show();
