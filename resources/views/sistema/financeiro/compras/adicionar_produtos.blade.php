...
<form id="form_compra">
@csrf
  <input type="hidden" name="cat_produtos" id="cat_produtos">
...
@include('includes.catch', [ 'codigo_erro' => '4563803a' ] )
    .then( function(response)
    {
  ...
  function compra_proximo()
  {
    ...
    axios.post("{{ route('fin.compras.create1') }}", produtos)
    .then( function(response)
    {
      // console.log(response)
      window.location.href = response.data.redirect
    })
@include('includes.catch', [ 'codigo_erro' => '6237518a' ] )
    .then( function()
    {
      // alert('s')
