<div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="modal_lancamentos">
  <form action="{{ route('lancamento.filtrar') }}" method="POST" autocomplete="off" id="form_lancamentos">
    {!! csrf_field() !!}
