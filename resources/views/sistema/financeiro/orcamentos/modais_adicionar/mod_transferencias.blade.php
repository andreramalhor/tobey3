  ...
  <div class='modal-dialog modal-lg'>
    <div class='modal-content'>
      ...
      <div class='row'>
          ...
          <div class='col-5' id='div_destino'>
            <div class='form-group'>
              <label>Para:</label>
          ...
          <div class='col-4'></div>
          <div id='div_valor' class='col-4' style='display: none'>
...
@include('includes.catch', [ 'codigo_erro' => '6346033a' ] )
  .then()
  {
...
@include('includes.catch', [ 'codigo_erro' => '7114743a' ] )
  }
}
...
@include('includes.catch', [ 'codigo_erro' => '9978492a' ] )
  .then()
  {
    $('#div_valor').show()
  }
...
@include('includes.catch', [ 'codigo_erro' => '6024118a' ] )
  .then(function()
  {
