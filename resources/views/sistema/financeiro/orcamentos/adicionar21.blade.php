...
@include('includes.catch', [ 'codigo_erro' => '7457507a' ] )
};
...
@include('includes.catch', [ 'codigo_erro' => '7924004a' ] )
  }
}
...
@include('includes.catch', [ 'codigo_erro' => '5422602a' ] )
}
...
@include('includes.catch', [ 'codigo_erro' => '6389654a' ] )
  .then()
  {
    $('#foto_enviar').hide();
    $('#foto_cancelar').show();
...
@include('includes.catch', [ 'codigo_erro' => '7730668a' ] )
  .then()
  {
    $('#foto_enviar').show();
    $('#foto_cancelar').hide();
