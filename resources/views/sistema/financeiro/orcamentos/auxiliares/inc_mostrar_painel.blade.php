		...
		<div class="card">
			...
			<div class="card-body p-0">
				<table class="table table-sm">
					...
					<tbody>
						@forelse($pessoa->eidwuedoeduzdsd->sortByDesc('id')->take(5) as $vendas_detalhes)
						<tr>
...
<div class="row">
	<div class="col-4">
		<div class="small-box bg-warning">
			<div class="inner">
				<h3>{{ $pessoa->eidwuedoeduzdsd->count() > 0 ? $pessoa->eidwuedoeduzdsd->sortByDesc('id')->first()->created_at->diffInDays(Carbon\Carbon::today()) : "99999" }}</h3>
				<p>Dias sem vir</p>
			</div>
			<div class="icon">
