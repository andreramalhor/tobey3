...
@include('includes.catch', [ 'codigo_erro' => '6591847a' ] )
};
...
@include('includes.catch', [ 'codigo_erro' => '5790808a' ] )
  }
}
...
@include('includes.catch', [ 'codigo_erro' => '2522390a' ] )
}
...
@include('includes.catch', [ 'codigo_erro' => '6468554a' ] )
  .then()
  {
    $('#foto_enviar').hide();
    $('#foto_cancelar').show();
...
@include('includes.catch', [ 'codigo_erro' => '3940403a' ] )
  .then()
  {
    $('#foto_enviar').show();
    $('#foto_cancelar').hide();
