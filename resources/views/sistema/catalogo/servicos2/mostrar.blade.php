    ...
    <div class="card">
      <div class="card-header d-flex p-0">
        ...
        <ul class="nav nav-pills ml-auto p-2">
          ...
          <li class="nav-item"><a class="nav-link" href="#usuarios" data-bs-toggle="tab">Usuários</a></li>
        </ul>
      </div>
      <div class="card-body">
            ...
            <div class="row">
              <div class="row invoice-info">
                ...
                <div class="col-sm-3 invoice-col">
                  ...
                  @include('sistema.sistema.acl.funcoes.auxiliares.inc_mostrar_color_checkbox', [ 'funcao_permissoes' => $funcao->YXWBGTOOPLYJJAZ, 'nome_permissao' => 'Teste_2.Menu',       'local' => 'Menu' ])
                  @include('sistema.sistema.acl.funcoes.auxiliares.inc_mostrar_color_checkbox', [ 'funcao_permissoes' => $funcao->YXWBGTOOPLYJJAZ, 'nome_permissao' => 'Teste_2.Detalhes',   'local' => 'Detalhes' ])
                  @include('sistema.sistema.acl.funcoes.auxiliares.inc_mostrar_color_checkbox', [ 'funcao_permissoes' => $funcao->YXWBGTOOPLYJJAZ, 'nome_permissao' => 'Teste_2.Criar',      'local' => 'Criar' ])
                  @include('sistema.sistema.acl.funcoes.auxiliares.inc_mostrar_color_checkbox', [ 'funcao_permissoes' => $funcao->YXWBGTOOPLYJJAZ, 'nome_permissao' => 'Teste_2.Editar',     'local' => 'Editar' ])
                  @include('sistema.sistema.acl.funcoes.auxiliares.inc_mostrar_color_checkbox', [ 'funcao_permissoes' => $funcao->YXWBGTOOPLYJJAZ, 'nome_permissao' => 'Teste_2.Excluir',    'local' => 'Excluir' ])
                </div>
                <div class="col-sm-4 invoice-col">
...
@include('includes.catch', [ 'codigo_erro' => '7564782a' ] )
    .then( function(response)
    {
...
@include('includes.catch', [ 'codigo_erro' => '3519806a' ] )
    .then( function(response)
    {
      funcoes_usuarios_tabelar();
    })
