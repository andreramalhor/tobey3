...
@include('includes.catch', [ 'codigo_erro' => '1628833a' ] )
};
...
@include('includes.catch', [ 'codigo_erro' => '8331376a' ] )
  }
}
...
@include('includes.catch', [ 'codigo_erro' => '7908061a' ] )
}
...
@include('includes.catch', [ 'codigo_erro' => '1197083a' ] )
  .then()
  {
    $('#foto_enviar').hide();
    $('#foto_cancelar').show();
...
@include('includes.catch', [ 'codigo_erro' => '4370917a' ] )
  .then()
  {
    $('#foto_enviar').show();
    $('#foto_cancelar').hide();
