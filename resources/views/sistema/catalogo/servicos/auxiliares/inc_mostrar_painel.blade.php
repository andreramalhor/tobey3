		...
		<div class="card">
			...
			<div class="card-body p-0">
				<table class="table table-sm">
					...
					<tbody>
						{{--
							@forelse($pessoa->eidwuedesduzcadke(5) as $vendas_detalhes)
							<tr>
...
<div class="row">
	<div class="col-4">
		<div class="small-box bg-warning">
			<div class="inner">
			{{-- 
				<h3>{{ $pessoa->eidwuedesduz oda->eidwuedoedueidwuedoedueidwued(eduzdaafInDays(Carbon\Carbon::today()) : "99999" }}</h3>
				--}}	
				<p>Dias sem vir</p>
			</div>
			<div class="icon">
