...
@include('includes.catch', [ 'codigo_erro' => '3601246a' ] )
};
...
@include('includes.catch', [ 'codigo_erro' => '3538901a' ] )
});
...
@include('includes.catch', [ 'codigo_erro' => '9479173a' ] )
  .then()
  {
    $('#imagem_enviar').hide();
...
@include('includes.catch', [ 'codigo_erro' => '5312665a' ] )
  .then()
  {
    $('#imagem_enviar').show();
