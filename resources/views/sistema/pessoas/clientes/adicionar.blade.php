...
@section('content')
<form id="form_clientes_adicionar" autocomplete="off">
  @csrf
  <div class="row">
    <div class="col-4">
      <div class="card">
          ...
          <div class="row">
            <div class="col-12">
              <div class="form-group">
                <label>Nome</label>
                <select class="form-control form-control-sm select2" name="id_pessoa" id="id_pessoa" onchange="selecionarCliente()">
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="text" class="form-control form-control-sm" id="tipo_pessoa" name="tipo_pessoa" value="Cliente" disabled="disabled">
                  <input type="hidden" id="id_tipo" name="id_tipo" value="4">
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="row">
    <div class="col-12">
      <a href="{{ route('pessoas.clientes') }}" class="btn btn-secondary">Cancel</a>
      <a class="btn btn-success float-right" style="color:white" id='submit_clientes_gravar'>Adicionar</a>
    </div>
  </div>
  <br>
</form>
...
function carregarPessoas()
{
  ...
  var url = url.replace(':tp', "mode=!=&tp=Cliente")
...
@include('includes.catch', [ 'codigo_erro' => '7827343a' ] )
  .then( function()
  {
...
$("#submit_clientes_gravar").on('click', function(e)
{
  e.preventDefault();

  let dados = $('#form_clientes_adicionar').serialize();
  console.log(dados)
  axios.post('{{ route('pessoas.clientes.gravar') }}', dados)
  .then(function(response)
  {
    console.log(response)
    // setTimeout(function(){
...
@include('includes.catch', [ 'codigo_erro' => '5597682a' ] )
});
</script>
@endsection
