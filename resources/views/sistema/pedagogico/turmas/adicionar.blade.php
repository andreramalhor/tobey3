...
@include('includes.catch', [ 'codigo_erro' => '1156046a' ] )
};
...
@include('includes.catch', [ 'codigo_erro' => '9330307a' ] )
  }
}
...
@include('includes.catch', [ 'codigo_erro' => '4878276a' ] )
}
...
@include('includes.catch', [ 'codigo_erro' => '8943698a' ] )
  .then()
  {
    $('#foto_enviar').hide();
    $('#foto_cancelar').show();
...
@include('includes.catch', [ 'codigo_erro' => '6510033a' ] )
  .then()
  {
    $('#foto_enviar').show();
    $('#foto_cancelar').hide();
