...
@include('includes.catch', [ 'codigo_erro' => '7895466a' ] )
};
...
@include('includes.catch', [ 'codigo_erro' => '2022014a' ] )
  }
}
...
@include('includes.catch', [ 'codigo_erro' => '6593618a' ] )
}
...
@include('includes.catch', [ 'codigo_erro' => '6376020a' ] )
  .then()
  {
    $('#foto_enviar').hide();
    $('#foto_cancelar').show();
...
@include('includes.catch', [ 'codigo_erro' => '3111727a' ] )
  .then()
  {
    $('#foto_enviar').show();
    $('#foto_cancelar').hide();
