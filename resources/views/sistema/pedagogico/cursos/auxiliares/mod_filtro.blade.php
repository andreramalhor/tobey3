<div class="modal fade" id="modal_cursos_filtrar" aria-hidden="true" style="display: none; color: black;">
    ...
    <form autocomplete="off" id="form-filtro">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-2">
              <div class="form-group">
              <label>Tipo</label>
                <select class="form-control form-control-sm" name="tipo_curso" id="tipo_curso">
                  <option value=""></option>
                  <option value="N">Normal</option>
                  <option value="E">Especialização</option>
                  <option value="P">Express</option>
            ...
            <div class="col-2">
              <div class="form-group">
                ...
                <input type="text" class="form-control form-control-sm" name="carga_horaria" id="carga_horaria">
              </div>
            </div>
            <div class="col-6"></div>
            <div class="col-2">
        ...
        <div class="modal-footer justify-content-between" style="padding: 6px 12px">
          ...
          <button type="button" class="btn btn-primary btn-sm" onclick="cursos_tabelar()" data-bs-dismiss="modal">Filtrar</button>
        </div>
      </div>
    </div>
  </form>
