...
@include('includes.catch', [ 'codigo_erro' => '3372564a' ] )
};
...
@include('includes.catch', [ 'codigo_erro' => '6261158a' ] )
  }
}
...
@include('includes.catch', [ 'codigo_erro' => '7738105a' ] )
}
...
@include('includes.catch', [ 'codigo_erro' => '4619942a' ] )
  .then()
  {
    $('#foto_enviar').hide();
    $('#foto_cancelar').show();
...
@include('includes.catch', [ 'codigo_erro' => '7435384a' ] )
  .then()
  {
    $('#foto_enviar').show();
    $('#foto_cancelar').hide();
