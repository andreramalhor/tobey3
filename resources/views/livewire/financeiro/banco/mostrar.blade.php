                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm @error('bd_nome') is-invalid @enderror" wire:model="bd_nome" placeholder="Nome" readonly>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm @error('bd_num_banco') is-invalid @enderror" wire:model="bd_num_banco" placeholder="000" readonly>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm @error('bd_num_agencia') is-invalid @enderror" wire:model="bd_num_agencia" placeholder="0000" readonly>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm @error('bd_num_conta') is-invalid @enderror" wire:model="bd_num_conta" placeholder="00000-0" readonly>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm text-right @error('bd_saldo_inicial') is-invalid @enderror" wire:model="bd_saldo_inicial" placeholder="0,00" readonly>
