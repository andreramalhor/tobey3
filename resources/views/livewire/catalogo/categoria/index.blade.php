<div class="row">
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <div class="row p-2">
                    ...
                    <div class="col-md-2">
                        <a class="btn btn-secondary btn-block btn-sm float-right" wire:click="create"><i class="fa fa-plus"></i> Nova categoria</a>
                    </div>
                </div>
                <table class="table">
    ...
    @include('livewire.catalogo.categoria.adicionar')
    @include('livewire.catalogo.categoria.show')
</div>
