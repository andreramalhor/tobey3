            ...
            <form wire:submit.prevent="atualizar">
                <div class="modal-header border-bottom-0 py-2 px-0">
                    <ul class="nav nav-tabs w-100">
                        <h3 class="card-title text-left pt-1 pr-5 pl-1 ml-2">Editar serviço</h3>
                        <li class="nav-item">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm @error('bd_marca') is-invalid @enderror" wire:model="bd_marca" placeholder="Marca">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm text-right dinheiro @error('bd_vlr_frete') is-invalid @enderror" wire:model="bd_vlr_frete" wire:change="atualizarValores">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm text-center percentual @error('bd_prc_comissao') is-invalid @enderror" wire:model="bd_prc_comissao" placeholder="0">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm text-right dinheiro @error('bd_vlr_comissao') is-invalid @enderror" wire:model="bd_vlr_comissao" placeholder="0">
